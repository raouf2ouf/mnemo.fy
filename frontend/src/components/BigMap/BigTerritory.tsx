...
const BigTerritory: React.FC<Props> = ({ id }) => {
  ...
  return (
    <>
      {sector && territory && (
        <g
          className="big-territory"
          style={
            {
              "--color": sector.color + "15",
              "--color-pure": sector.color,
              "--color-shade": sector.color + "70",
            } as any
          }
        >
...
export default memo(BigTerritory);
